...
import { Users, TrendingUp, DollarSign, Package, AlertTriangle, CheckCircle, Eye, Ban, UserCheck, Building, BarChart3, Globe, Shield } from 'lucide-react';
  ...
  const systemAlerts = [
    {
      ...
      message: 'Monthly transaction volume has increased by 25% this week',
      time: '2 hours ago',
    },
    {
      id: '2',
      ...
      message: '3 companies failed GSTIN verification in the last 24 hours',
      time: '4 hours ago',
    },
    {
      id: '3',
      ...
      message: 'Multiple users requesting bulk upload feature',
      time: '1 day ago',
    },
  ];
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="mt-4">
                <span className="text-green-600 text-sm font-medium">+{stats.monthlyGrowth}% this month</span>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">₹{(stats.totalVolume / 10000000).toFixed(1)}Cr</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">₹{(stats.platformRevenue / 100000).toFixed(1)}L</p>
                </div>
                  ...
                  {recentTransactions.map((transaction) => (
                    <div key={transaction.id} className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm text-green-600">Commission: ₹{transaction.commission.toLocaleString()}</p>
                      </div>
                    </div>
                  ))}
                </div>
