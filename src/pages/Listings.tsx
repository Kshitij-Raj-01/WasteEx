      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sortedListings.map((listing) => (
            <div key={listing._id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
              {/* Image */}
                ...
                <div className="flex items-center justify-between">
                  ...
                  {user?.type === 'buyer' && user._id !== listing.seller._id && (
                    <div className="flex space-x-2">
                      <button
                        onClick={() => handleInquire(listing._id)}
                      ...
                      <button
                        onClick={() => startNegotiation(listing._id)}
